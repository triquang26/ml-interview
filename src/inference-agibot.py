...
MODEL_SAVE_DIR = "/mnt/data/sftp/data/quangpt3/difgit/ml-interview/outputs/saved_models/experiment5-agibot/agibot"
OUTPUT_DIR = str(REPO_ROOT / "outputs" / "benchmark-report" / "experiment5-agibot")
UNIQUE_TOKEN = "sks"
CLASS_NAME = "first-person view of double robotic arms"
POSE_PATHS = [
    "/mnt/data/sftp/data/quangpt3/difgit/ml-interview/dataset-dreambooth-agibot/instance/pose/03.jpg",
    "/mnt/data/sftp/data/quangpt3/difgit/ml-interview/dataset-dreambooth-agibot/instance/pose/28.jpg"
]
...
for pose_idx, pose_path in enumerate(POSE_PATHS, start=1):
    ...
    pose_map = Image.open(pose_path).convert("RGB").resize((512, 512), Image.Resampling.BILINEAR)
