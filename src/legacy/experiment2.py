...
MODEL_SAVE_DIR = str(REPO_ROOT / "outputs" / "saved_models" / "our_controlnet_lora")
...
def train_and_save(class_name, instance):
    ...
    optimizer = torch.optim.AdamW(itertools.chain(unet.parameters(), text_encoder.parameters()), lr=LR, weight_decay=1e-4)
